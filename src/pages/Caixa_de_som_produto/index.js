...
class ProdutoCaixa extends Component{
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/cabos/${img}`,
            preco: avista,
            diretorio: `/produtoCaixa/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpCaixasom/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoCaixasom/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_caixasom" src={`/image/caixas_de_som/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_caixasom">{nome}</h1>
                            <p id="avista" className="preco_produto_caixasom" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_caixasom">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_caixasom">R$ {avista}</p>
