...
class Fones extends Component{
   ...
   async deleteItem(id){
        ...
        await ax.delete(`http://localhost:8081/item/produtoDelFone/${id}`).then(() => {
    ...
    getProduto(){
        ax.get('http://localhost:8081/item/fone').then(response => 
                    ...
                    items.map(produtos => {
                        ...
                        return(
                                <div key={id} id="container_product">
                                    <button id="btn_delete_fone" onClick={() => this.deleteItem(id)}>X</button>
                                    <img id="img_fone" src={`/image/fones/${img}`} alt="img_produto"/>
                                    ...
                                    <button id="btn_acessar"><Link to={`/produtofone/item/${id}`} id="link_btn" >Acessar</Link></button>         
                                </div>
                        );
                    })
                ) 
