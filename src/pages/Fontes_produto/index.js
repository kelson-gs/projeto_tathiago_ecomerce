...
class ProdutoFonte extends Component{
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/fontes/${img}`,
            preco: avista,
            diretorio: `/produtoFonte/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpFonte/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoFonte/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_fonte" src={`/image/fontes/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_fonte">{nome}</h1>
                            <p id="avista" className="preco_produto_fonte" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_fonte">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_fonte">R$ {avista}</p>
