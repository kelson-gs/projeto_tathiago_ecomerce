...
class ProdutoPilha extends Component{
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/pilhas/${img}`,
            preco: avista,
            diretorio: `/produtoPilha/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpPilha/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoPilha/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_pilha" src={`/image/pilhas/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_pilha">{nome}</h1>
                            <p id="avista" className="preco_produto_pilha" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_pilha">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_pilha">R$ {avista}</p>
