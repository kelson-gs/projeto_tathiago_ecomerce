...
import './extensoesProduto.css';
import ax from '../../service/ax';
import NavHsc from '../../componentes/Nav_hsc';

class ProdutoExtensao extends Component{
    constructor(props){
        super(props);
        this.state = {
            adm: this.admMessage(),
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/extensões/${img}`,
            preco: avista,
            diretorio: `/produtoExtensao/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpExtensao/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoExtensao/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_extensao" src={`/image/extensão/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_extensao">{nome}</h1>
                            <p id="avista" className="preco_produto_extensao" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_extensao">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_extensao">R$ {avista}</p>
...
export default ProdutoExtensao;
