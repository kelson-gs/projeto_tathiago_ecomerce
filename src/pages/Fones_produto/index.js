...
class ProdutoFone extends Component{
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpFone/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoFone/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_fone" src={`/image/fones/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_fone">{nome}</h1>
                            <p id="avista" className="preco_produto_fone" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_fone">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_fone">R$ {avista}</p>
