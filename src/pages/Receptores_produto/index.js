...
import './receptoresProduto.css';
import ax from '../../service/ax';
import NavHsc from '../../componentes/Nav_hsc';

class ProdutoReceptor extends Component{
    constructor(props){
        super(props);
        this.state = {
            adm: this.admMessage(),
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/receptores/${img}`,
            preco: avista,
            diretorio: `/produtoReceptor/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpReceptor/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoReceptor/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_receptor" src={`/image/receptores/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_receptor">{nome}</h1>
                            <p id="avista" className="preco_produto_receptor" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_receptor">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_receptor">R$ {avista}</p>
...
export default ProdutoReceptor;
