...
import './bateriasProduto.css';
import ax from '../../service/ax';
import NavHsc from '../../componentes/Nav_hsc';

class ProdutoBateria extends Component{
    constructor(props){
        super(props);
        this.state = {
            adm: this.admMessage(),
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/baterias/${img}`,
            preco: avista,
            diretorio: `/produtoBateria/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpBateria/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoBateria/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_bateria">{nome}</h1>
                            <p id="avista" className="preco_produto_bateria" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_bateria">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_info_img">
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_bateria" src={`/image/baterias/${img}`} alt="img_produto"/>
                                    <label id="esgotado">ESGOTADO</label>
                                </div>
                            ):(
                                <img id="img_produto_bateria" src={`/image/baterias/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_bateria">R$ {avista}</p>
