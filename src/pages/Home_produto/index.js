...
class ProdutoHome extends Component{
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/produtohome/${img}`,
            preco: avista,
            diretorio: `/produtoProdutohome/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpProdutohome/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoProdutohome/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_produtohome" src={`/image/produtohome/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_produtohomer">{nome}</h1>
                            <p id="avista" className="preco_produto_produtohome" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_produtohome">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_produtohome">{nome}</h1>
                            <p id="cartao" className="preco_produto_produtohome">R$ {cartao}</p>
                            ...
                            <p id="avista" className="preco_produto_produtohome">R$ {avista}</p>
