...
import './roteadoresProduto.css';
import ax from '../../service/ax';
import NavHsc from '../../componentes/Nav_hsc';

class ProdutoRoteador extends Component{
    constructor(props){
        super(props);
        this.state = {
            adm: this.admMessage(),
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/roteadores/${img}`,
            preco: avista,
            diretorio: `/produtoRoteadore/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpRoteador/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoRoteador/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_roteador" src={`/image/roteadores/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_roteador">{nome}</h1>
                            <p id="avista" className="preco_produto_roteador" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_roteador">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_roteador">R$ {avista}</p>
...
export default ProdutoRoteador;
