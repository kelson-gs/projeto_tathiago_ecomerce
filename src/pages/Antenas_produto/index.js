...
class ProdutoAntena extends Component{
    ...
    comprar(){
        ...
        /*
        ax.put(`http://localhost:8081/item/produtoUpAntena/${id}`, {
            newAvista: `${avista}`,
            newCartao: `${cartao}`,
            newQuantidade: `${quantidade - newQuantidade}`
        }).then((accert) => {
            console.log(accert);
        }).catch((err) => {
            console.log(err);
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/antenas/${img}`,
            preco: avista,
            diretorio: `/produtoAntena/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpAntena/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoAntena/${id}`).then(response => {
    ...
    render(){
        const {nome, img, info1, info2, info3, info4, avista, cartao, quantidade} = this.state.item;
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_antena" src={`/image/antenas/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_antena">{nome}</h1>
                            <p id="avista" className="preco_produto_antena" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_antena">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_antena">R$ {avista}</p>
