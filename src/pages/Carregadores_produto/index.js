...
import './carregadoresProduto.css';
import ax from '../../service/ax';
import NavHsc from '../../componentes/Nav_hsc';

class ProdutoCarregador extends Component{
    constructor(props){
        super(props);
        this.state = {
            adm: this.admMessage(),
    ...
    adccar(){
        ...
        const itemCar = {
            ...
            img: `/image/carregadores/${img}`,
            preco: avista,
            diretorio: `/produtoCarregador/item/${id}`
        };
    ...
    async updatePrecoEquantidade(){
        ...
        await ax.put(`http://localhost:8081/item/produtoUpCarregador/${id}`, {
            newAvista: `${newAvista}`,
            newCartao: `${newCartao}`,
    ...
    async getOneItem(){
        const { id } = this.state;
        await ax.get(`http://localhost:8081/item/produtoCarregador/${id}`).then(response => {
                ...
                {adm === "admin" ? (
                    <div id="container_one_produto">
                        <div>
                            {quantidade === 0 ? (
                                <div>
                                    <img id="img_produto_carregador" src={`/image/carregadores/${img}`} alt="img_produto"/>
                        ...
                        <div id="container_compra">
                            <h1 id="title_produto_carregador">{nome}</h1>
                            <p id="avista" className="preco_produto_carregador" step='0.00'>R$ {avista}</p>
                            ...
                            <p id="cartao" className="preco_produto_carregador">R$ {cartao}</p>
                    ...
                    <div id="container_one_produto">
                        ...
                        <div id="container_compra">
                            ...
                            <p id="avista" className="preco_produto_carregador">R$ {avista}</p>
...
export default ProdutoCarregador;
